...
class ChangePassword extends PureComponent {
  ...
  constructor(props) {
    ...
    this.warnNotification = this.warnNotification.bind(this);
  ...
  onSubmit = async () => {
    ...
    if (data.newpassword !== data.confirmpassword) {
      ...
      this.warnNotification('Password Mismatch');
    ...
    if (passmatch) {
      ...
      if (res.data.statusCode !== 1) {
        this.warnNotification(res.data.message);
        this.formApi.reset();
      }
      if (res.data.statusCode === 1) {
